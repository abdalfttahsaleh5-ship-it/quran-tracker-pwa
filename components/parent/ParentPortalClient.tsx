                    ...
                    >
                      <div className="flex items-center justify-between gap-2">
                        ...
                        {juz.isCompleted ? (
                          ...
                          <span className="px-2 py-0.5 rounded-full text-[11px] font-bold bg-slate-100 dark:bg-slate-800 text-slate-500 border border-slate-200 dark:border-slate-700">
                            لم يبدأ بعد
                          </span>
                        )}
                      </div>
